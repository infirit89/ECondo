...
namespace ECondo.Infrastructure.Migrations
{
    ...
    [Migration("20250324205807_BuildingMigration")]
    partial class BuildingMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECondo.Domain.Buildings.City", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ECondo.Domain.Buildings.Building", b =>
                {
                    b.HasOne("ECondo.Domain.Buildings.City", "City")
                        .WithMany("Buildings")
